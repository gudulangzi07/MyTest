package com.mytest.widget.rating;
...
public class RatingStarView extends View implements View.OnClickListener {
    ...
    public RatingStarView(Context context, @Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes) {
        super(context, attrs, defStyleAttr, defStyleRes);
        init(attrs, defStyleAttr, defStyleRes);
    }

    private void init(@Nullable AttributeSet attrs, int defStyleAttr, int defStyleRes){
        final TypedArray typedArray = getContext().obtainStyledAttributes(attrs, R.styleable.RatingStarView, defStyleAttr, defStyleRes);
        ...
        drawStrokeForEmptyStar = typedArray.getBoolean(R.styleable.RatingStarView_drawStrokeForEmptyStar, true);
        drawStrokeForFullStar = typedArray.getBoolean(R.styleable.RatingStarView_drawStrokeForFullStar, false);
        drawStrokeForHalfStar = typedArray.getBoolean(R.styleable.RatingStarView_drawStrokeForHalfStar, true);
        enableSelectRating = typedArray.getBoolean(R.styleable.RatingStarView_enableSelectRating, false);
        onlyHalfStar = typedArray.getBoolean(R.styleable.RatingStarView_onlyHalfStar, true);
        typedArray.recycle();
    ...
    private void drawPartialStar(StarModel star, Canvas canvas, float percent) {
        ...
        dividerX = star.getOuterRect().left + star.getOuterRect().width() * percent;
