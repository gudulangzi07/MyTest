 ...
 * @author: 张京伟
 * @date: 2015/12/31 17:02
 * @Description: UncaughtException处理类, 当程序发生Uncaught异常的时候, 有该类来接管程序, 并记录发送错误报告.
 * 需要在Application中注册，为了要在程序启动器就监控整个程序。
 * 这里只做错误日志的收集，错误日志在下次APP启动的时候发送到服务器，写在WelcomeActivity.java中
 * @version: 1.0
 */
    ...
    public void collectDeviceInfo(Context ctx) {
        try {
            ...
            if (pi != null) {
                ...
                infos.put("release", Build.VERSION.RELEASE);//手机系统版本号
            }
...
//        sb.append("model=" + infos.get("model") + "\n");
//        sb.append("release=" + infos.get("release") + "\n");
...
//                File dir = new File(FILE_PATH_CRASH);
//                if (!dir.exists()) {
//                    dir.mkdirs();
//                }
//
//                File file = new File(FILE_PATH_CRASH, fileName);
